...
2026-09-18 应用更新入口进展：“关于”已接入主动检查、版本说明、按发行模式选择附件、带进度且可取消的强制校验下载，以及文件夹/发布页面入口。70 项源码和 71 项包内测试通过，真实 GitHub 清单及新 EXE 启动通过；见[应用内更新证据](../evidence/2026-09-18-in-app-update-download.md)。自动启动更新器或安装器尚未接入；T11 继续保持未完成。
