...
- [ ] Reproduce cancellation while waiting for headers and while streaming a body
...
- [ ] Implement cancellation through the full stream, retain normal error paths,
  and ensure no install occurs after acquisition cancellation.
- [ ] Verify successful download/install and existing checksum/trust regressions.
